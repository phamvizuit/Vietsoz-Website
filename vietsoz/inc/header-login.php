...
<header>
    <nav class="container main-nav">
        ...
        <ul id="main-menu" class="d-flex">
            ...
            <li><a href='?mod=page&act=profile&username=<?php echo $_SESSION['username']; ?>'><i class='fas fa-user'></i>Tài khoản</a></li>
            <li><a href='?mod=user&act=logout'><i class='fas fa-sign-out-alt'></i>Logout</a></li>
        </ul>
